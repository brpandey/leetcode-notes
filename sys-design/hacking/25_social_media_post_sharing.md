...
In many applications, posts are accessed from a newsfeed or a timeline. In the next chapt
we'll design both components, building on top of this chapter's design.
